...
exports指向module.exports，如果直接给exports赋值，会切断引用，导致导出为空。
...
- CommonJS会有一些顶层变量：`require`、`module`、`exports`、`__filename`、`__dirname`
...
首先Babel其实为了将ES6的代码转换为向后兼容的代码，以便在旧浏览器中运行
